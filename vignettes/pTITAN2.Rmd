...
#bring in saved TITAN$sumz data for all four regions
CD <- as.data.frame(CD_obs$sumz)
CN <- as.data.frame(CN_obs$sumz)

#create a table of the median change point from TITAN to be used to calculate p-values
TITAN_med <-  rbind(CD, CN) %>%
...
#reorganize the filtered permutations
...
# Calulating the p-values -----------------------------------------------
data_frame(treatment = "T1T2_CDCN", 
                  "fsumz-" = (sum((
